...
(let ((class '((class color) (min-colors 89)))
      ...
      (completion-other-candidates '(:weight normal :foreground "black" :background "#EBF4FE" :extend t))
      (completion-selected-candidate '(:weight normal :foreground "black" :background "#B5D5F5" :extend t))
      ...
      (link '(:weight normal :underline "#696969" :foreground "#006DAF" :background "#E5E5E5"))
      ...
      (marked-line '(:foreground "#AA0000" :background "#FFAAAA" :extend t))
      (match '(:weight bold :background "#FBE448" :extend t)) ; occur patterns
      ...
      (ol2 '(:height 1.2 :weight bold :overline "#123555" :foreground "#123555" :background "#E5F4FB" :extend t))
      (ol3 '(:height 1.1 :weight bold :foreground "#005522" :background "#EFFFEF" :extend t))
  ...
  (custom-theme-set-faces
   ...
   ;; edebug-x
   `(hi-edebug-x-stop ((,class (:background "orange" :extend t))))
   `(hi-edebug-x-debug-line ((,class (:background "pink" :extend t))))
   ...
   `(company-tooltip-common ((,class (:inherit company-tooltip :weight normal :foreground "OliveDrab")))) ; Prefix + common part in tooltip.
   `(company-tooltip-common-selection ((,class (:inherit company-tooltip-selection :weight normal :foreground "forest green")))) ; Prefix + common part in tooltip (for selection).
   `(company-tooltip-annotation ((,class (:weight normal :background "#DFE8F1")))) ; Annotation.
   `(company-tooltip-annotation-selection ((,class (:weight normal)))) ; Annotation (for selection).
   `(company-preview ((,class (:foreground "black" :background "light gray")))) ; Preview
   `(company-preview-common ((,class ,completion-inline))) ; Preview
   `(company-preview-search ((,class (:inherit company-preview :foreground "forest green")))) ; Preview
   `(company-scrollbar-bg ((,class (:background "#EBF4FE")))) ; Scrollbar
   `(company-scrollbar-fg ((,class (:background "#D1DAE4")))) ; Scrollbar (visible).

   `(company-box-background ((,class ,completion-other-candidates)))
   `(company-box-candidate ((,class ,completion-other-candidates)))
   `(company-box-annotation ((,class (:inherit company-tooltip-annotation))))
   `(company-box-selection ((,class ,completion-selected-candidate)))
   ...
   `(elfeed-read-face ((,class (:foreground "gray" :background "white"))))
   `(elfeed-unread-face ((,class (:foreground "#404040" :weight bold))))
   `(elfeed-search-title-face ((,class (:foreground "gray"))))
   `(elfeed-search-unread-title-face ((,class (:foreground "#404040" :weight bold))))
   ...
   `(hl-line ((,class (:background "#C7ECC1" :extend t)))) ; Highlight current line.
   `(hl-tags-face ((,class ,highlight-current-tag))) ; ~ Pair highlighting (matching tags).
   `(hl-sexp-face ((,class (:background "#DDDDDD" :extend t))))
   ...
   `(magit-diff-base-highlight ((,class (:foreground "orange" :extend t))))
   `(magit-diff-context-highlight ((,class (:background "#EAEAEA" :extend t))))
   `(magit-diff-added-highlight ((,class (:foreground "#00CC00" :background "#E0E0E0" :extend t))))
   `(magit-diff-removed-highlight ((,class (:foreground "IndianRed2" :background "#E0E0E0" :extend t))))
   `(magit-diff-lines-heading ((,class (:background "orange2" :extend t))))
   ...
   `(magit-section-highlight ((,class (:background "#E6E6E6" :extend t))))
   `(magit-diff-file-heading-highlight ((,class (:background "#E6E6E6" :extend t))))
   ...
   `(org-agenda-dimmed-todo-face ((,class ("#CBCBCB" :background "#ffffff" :strike-through t :extend t))))
   `(org-agenda-done ((,class (:foreground "#CBCBCB" :background "#ffffff" :extend t))))
   ...
   `(org-archived ((,class (:foreground "gray70" :strike-through t :extend t))))
   ...
   `(org-clock-overlay ((,class (:foreground "white" :background "SkyBlue4" :extend t))))
   ...
   `(org-document-title ((,class (:height 1.8 :weight bold :extend t :foreground "black"))))
   `(org-done ((,class (:weight bold :box (:line-width 1 :color "#BBBBBB") :foreground "#BBBBBB" :background "#F0F0F0"))))
   `(org-drawer ((,class (:foreground "light sky blue" :background "#EAFFEA" :extend t))))
   `(org-ellipsis ((,class (:underline nil :foreground "#999999")))) ; #FFEE62
   `(org-example ((,class (:foreground "blue" :background "#EAFFEA" :extend t))))
   `(org-footnote ((,class (:underline t :foreground "#008ED1"))))
   `(org-formula ((,class (:foreground "chocolate1"))))
   `(org-headline-done ((,class (:height 1.0 :weight normal :strike-through t :foreground "#ADADAD" :extend t))))
   ...
   `(org-quote ((,class (:slant italic :foreground "dim gray" :background "#FFFFE0" :extend t))))
   ...
   `(org-tag ((,class (:weight normal :foreground "#9A9FA4" :background "white"))))
   ...
   `(org-upcoming-deadline ((,class (:weight normal :foreground "#222222" :background "#ffbfde" :extend t))))
   `(org-warning ((,class (:weight bold :foreground "#444444" :background "#ffd3d3" :extend t))))
   `(outline-1 ((,class ,ol1)))
   `(outline-2 ((,class ,ol2)))
   `(outline-3 ((,class ,ol3)))
   `(outline-4 ((,class ,ol4)))
   ...
   `(mu4e-header-face ((,class (:foreground "gray"))))
   `(mu4e-unread-face ((,class (:foreground "#444444" :weight bold))))
   `(mu4e-header-highlight-face ((,class (:foreground "gray" :background "#808080" :weight bold :extend t))))
   `(mu4e-header-mark-face ((,class (:foreground "white" :background "tomato" :extend t))))
   `(mu4e-replied-face ((,class (:foreground "black" :background "cornsilk" :extend t))))
   `(mu4e-flagged-face ((,class (:foreground "white" :background "LightSlateBlue" :extend t))))
